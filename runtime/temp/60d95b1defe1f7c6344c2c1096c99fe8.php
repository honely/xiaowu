<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"G:\xampp\htdocs\bbb\public/../application/decoration\view\index\editattch.html";i:1544250051;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    layui.use( ['form','jquery','upload','laydate'], function(){
        ...
        form.on('submit(saveInfo)', function(){
            ...
            if(
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?=url('index/editattch')?>?h_id=<?php echo $h_b_id; ?>&type=<?php echo $type; ?>",
