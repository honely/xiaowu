<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"G:\xampp\htdocs\bbb\public/../application/admin\view\setinfo\addtype.html";i:1536392561;s:70:"G:\xampp\htdocs\bbb\public/../application/admin\view\index\header.html";i:1536287308;s:70:"G:\xampp\htdocs\bbb\public/../application/admin\view\index\footer.html";i:1525742360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <form class="layui-form layui-form-pane1" action="<?=url('setinfo/addtype')?>?type=<?php echo $type; ?>" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="type_name" lay-verify="required" placeholder=
                        <?php if($type == 1): ?>
                            '请输入房屋类型'
                        <?php elseif($type == 2): ?>
                            '请输入风格名称'
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <?php if($type == 5): ?>
                    <div class="layui-input-inline" style="width: 100px;">
                        <input type="text" name="minArea" lay-verify="required"  autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid">-</div>
                    <div class="layui-input-inline" style="width: 100px;">
                        <input type="text" name="maxArea" lay-verify="required"  autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid">单位：（m²）</div>
                    <div class="layui-form-mid layui-word-aux">请填写请填写月租范围（如：0-500 表示月租大于等于0，小于500）</div>
                <?php else: ?>
                <div class="layui-input-block">
                    ...
                    "请输入创意字段"
                    <?php endif; ?>
                    name="type_remarks" lay-verify="required" class="layui-textarea"></textarea>
                </div>
                <?php endif; ?>
            </div>
