<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"G:\xampp\htdocs\bbb\public/../application/manager\view\allot\editbase.html";i:1544419580;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    $('#subBtn').click(function () {
        ...
        mui.confirm('确认修改？', 'Hello MUI', btnArray, function (e) {
            if (e.index == 1) {
                $.ajax({
                    'type': "post",
                    'url': "<?=url('allot/editbase')?>?h_id=<?php echo $h_b_id; ?>",
