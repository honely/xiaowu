<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"E:\houtai\xiaowu\xiaowu\public/../application/admin\view\banner\banner.html";i:1568011762;s:74:"E:\houtai\xiaowu\xiaowu\public/../application/admin\view\index\header.html";i:1567735110;s:74:"E:\houtai\xiaowu\xiaowu\public/../application/admin\view\index\footer.html";i:1567735110;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use(['table','laydate','form'], function(){
        ...
        table.render({
            ...
            ,height: 'full-200'
            ,cols: [[
                {field:'ba_bid', sort: true, title:'广告编号'}
                ,{field:'ba_title',title: '广告名称'}
                ,{field:'ba_img', title: '广告封面',templet:'<div><img src="__PUBLIC__{{ d.ba_img}}"></div>'}
                ,{field:'ba_order',title: '广告排序',edit:'text', sort: true}
                ,{field:'ba_createtime', title: '操作时间'}
                ,{field:'ad_realname',title: '操作人'}
                ,{field:'ba_isable',templet: '#switchTpl',sort:true, unresize: true, title:'是否显示' }
