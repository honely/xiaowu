<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"G:\xampp\htdocs\bbb\public/../application/manager\view\allot\logdetails.html";i:1543978709;}*/ ?>
<!DOCTYPE html>
<html>
...
<header class="mui-bar mui-bar-nav">
    <a class="mui-icon mui-icon-left-nav mui-pull-left" href="<?=url('allot/declog')?>?h_id=<?php echo $logs['hdl_house_code']; ?>&type=<?php echo $type; ?>"></a>
    <h1 class="mui-title">日志详情</h1>
</header>
<div class="mui-content">
    <div class="mui-content-padded">
        <h4><b>房源编号</b>【<?php echo $logs['hdl_house_code']; ?>】</h4>
        <p></p>
        <p>
