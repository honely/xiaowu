            ...
            <form class="layui-form" id="conponForm">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="cp_title" value="<?php echo $conpon['cp_title']; ?>" lay-verify="required|title" placeholder="请输入优惠券标题" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color: red;">*</span>优惠金额</label>
                    <div class="layui-input-inline">
                        <input type="text" value="<?php echo $conpon['cp_money']; ?>" onkeyup="this.value=this.value.replace(/\D/g, '')" name="cp_money" lay-verify="required" placeholder="请输入优惠金额" autocomplete="off" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" readonly value="<?php echo $conpon['cp_deadline']; ?>" id="cp_deadline" name="cp_deadline" lay-verify="required" placeholder="请选择截止日期" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <label class="layui-form-label"><span style="color: red;">*</span>优惠券摘要</label>
                    <div class="layui-input-block">
                        <textarea placeholder="请输入优惠券摘要" lay-verify="required" name="cp_desc" class="layui-textarea"><?php echo $conpon['cp_desc']; ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
...
<script>
    layui.use(['form', 'jquery','laydate'], function(){
        ...
        form.on('submit(saveInfo)', function(data){
            $.ajax({
                'type':"post",
                'url':"<?=url('customer/editconpon')?>?cp_id=<?php echo $conpon['cp_id']; ?>",
