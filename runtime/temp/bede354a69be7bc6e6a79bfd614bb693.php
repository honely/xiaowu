<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"G:\xampp\htdocs\bbb\public/../application/admin\view\regin\editcity.html";i:1541388530;s:70:"G:\xampp\htdocs\bbb\public/../application/admin\view\index\header.html";i:1536287308;s:70:"G:\xampp\htdocs\bbb\public/../application/admin\view\index\footer.html";i:1525742360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div style="padding: 15px;">
        <form class="layui-form layui-form-pane1" >
                ...
                <div class="layui-input-block">
                    <select name="p_id" lay-verify="required" id="p_id">
                        ...
                        <?php if(is_array($prov) || $prov instanceof \think\Collection || $prov instanceof \think\Paginator): $i = 0; $__LIST__ = $prov;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $vo['p_id']; ?>" <?php if($vo['p_id'] == $city['p_id']): ?>selected<?php endif; ?>><?php echo $vo['p_name']; ?></option>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="c_name" id="c_name" value="<?php echo $city['c_name']; ?>" lay-verify="required" required placeholder="请输入城市名称" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><span style="color: red;">*</span>城市编码</label>
                <div class="layui-input-inline">
                    <input type="text" name="c_code" id="c_code" lay-verify="required" value="<?php echo $city['c_code']; ?>" placeholder="请输入城市编码" autocomplete="off" class="layui-input">
                </div>
...
<script>
    layui.use(['form','jquery'], function(){
        ...
        $('#saveInfo').click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=url('regin/editcity')?>?c_id=<?php echo $city['c_id']; ?>",
