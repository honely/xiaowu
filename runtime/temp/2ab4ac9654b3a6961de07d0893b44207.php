<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"G:\xampp\htdocs\bbb\public/../application/operation\view\index\decdetails.html";i:1544076922;}*/ ?>
<!DOCTYPE html>
<html>
...
<header class="mui-bar mui-bar-nav">
    <a class="mui-icon mui-icon-left-nav mui-pull-left" href="<?=url('index/decorate')?>?b_id=<?php echo $logs['hdl_house_code']; ?>"></a>
