<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"G:\xampp\htdocs\bbb\public/../application/manager\view\allot\declog.html";i:1543978490;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="mui-collapse-content">
                    <ul class="mui-table-view" style="margin-top: -8px;">
                        ...
                        <li class="mui-table-view-cell">
                            <a href="<?=url('allot/logdetails')?>?hdl_id=<?php echo $vo['hdl_id']; ?>&type=<?php echo $type; ?>">
