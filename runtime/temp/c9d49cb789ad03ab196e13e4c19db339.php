<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"G:\xampp\htdocs\bbb\public/../application/manager\view\allot\editattch.html";i:1544420162;}*/ ?>
<!DOCTYPE html>
<html>
...
<header class="mui-bar mui-bar-nav">
    <a class="mui-icon mui-icon-left-nav mui-pull-left" href="<?=url('allot/details')?>?h_id=<?php echo $h_b_id; ?>&type=<?php echo $type; ?>"></a>
    ...
    layui.use( ['form','jquery','upload','laydate'], function(){
        ...
        form.on('submit(saveInfo)', function(){
            ...
            if(
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?=url('allot/editattch')?>?h_id=<?php echo $h_b_id; ?>&type=<?php echo $type; ?>",
                    ...
                    success: function(data){
                        ...
                        if(data.code="1"){
                            mui.alert(data.msg, function() {
                                window.location.href="<?=url('allot/details')?>?h_id=<?php echo $h_b_id; ?>&type=<?php echo $type; ?>";
                            });
                        }else{
                            mui.alert(data.msg);
                        }
        ...
        upload.render({
            elem: '#upload'
            ,url: '<?php echo url("marketm/common/upload"); ?>'
