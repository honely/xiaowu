<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"G:\xampp\htdocs\bbb\public/../application/manager\view\index\maintain.html";i:1544436489;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="mui-card">
        <div class="mui-card-content">
            <ul class="mui-table-view mui-table-view-chevron" id="getMore" >
                ...
                <li class="mui-table-view-cell mui-media">
                    <a class="mui-navigate-right" href="<?=url('index/maindetails')?>?hmt_id=<?php echo $log['hmt_id']; ?>">
