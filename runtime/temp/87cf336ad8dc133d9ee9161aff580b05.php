<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"G:\xampp\htdocs\bbb\public/../application/manager\view\index\allot.html";i:1543043027;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="mui-content" style="padding-top: 40px;">
    <?php if(is_array($marToDec) || $marToDec instanceof \think\Collection || $marToDec instanceof \think\Paginator): $i = 0; $__LIST__ = $marToDec;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?>
    <div class="mui-card">
