<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"G:\xampp\htdocs\bbb\public/../application/wap\view\index\person.html";i:1543374248;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="mui-content">
    <div class="mui-content-padded">
        <a href="<?=url('index/resetpwd')?>" class="mui-btn mui-btn-primary mui-btn-block">修改密码</a>
    </div>
    <div class="mui-content-padded">
