<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"G:\xampp\htdocs\bbb\public/../application/decoration\view\index\index.html";i:1543049212;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                if(data.length<=0){
                    ...
                    for (var i=0;i<data.length;i++) {
                        ...
                        html+=' 签订日期：'+data[i].h_addtime+'<br/>'+
                            ...
                            '            <a class="mui-card-link" href="<?=url('index/timeline')?>?h_id='+data[i].h_b_id+'">装修进度</a>\n' +
                            '            <a class="mui-card-link" href="<?=url('index/dailylog')?>?h_id='+data[i].h_b_id+'">监理记录</a>\n' +
                            '        </div></div>';
                    }
                }
                $('#getMore').append(html);
