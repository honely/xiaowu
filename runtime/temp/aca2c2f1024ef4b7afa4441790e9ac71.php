<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"G:\xampp\htdocs\bbb\public/../application/operation\view\index\logdetails.html";i:1543805972;}*/ ?>
<!DOCTYPE html>
<html>
...
<header class="mui-bar mui-bar-nav">
    <a class="mui-icon mui-icon-left-nav mui-pull-left"
       href="<?=url('index/maintlog')?>?h_id=<?php echo $logs['hmt_house_code']; ?>"
    ></a>
