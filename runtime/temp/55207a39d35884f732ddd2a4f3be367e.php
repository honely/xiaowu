<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"G:\xampp\htdocs\bbb\public/../application/operation\view\index\editbase.html";i:1544420483;}*/ ?>
<!DOCTYPE html>
<html>
...
<header class="mui-bar mui-bar-nav">
    <a class="mui-icon mui-icon-left-nav mui-pull-left" href="<?=url('index/details')?>?h_id=<?php echo $h_b_id; ?>"></a>
                    ...
                    'success': function (result) {
                        ...
                        if (result.code == '1') {
                            mui.alert(result.msg, function () {
                                window.location.href = "<?=url('index/details')?>?h_id=<?php echo $h_b_id; ?>";
                            });
                        } else {
