...
class SmsDemo
{
    ...
    //1.事业部提交到行政部，通知行政部人员
    public static function sendMarToAdm($phone,$signName,$templateCode,$name,$keyId,$KeySecret) {
        ...
        // 发起访问请求
        $acsResponse = static::getAcsClient($keyId,$KeySecret)->getAcsResponse($request);
