...
$(document).ready(function(){
    ...
    //弹出框
    $(".click,.shows,.flowBtn,.onclick").click(function(){
        $(".tg_wrap").show();
    });
    ...
    $(".listImg1").click(function(){
        $(".popping1").show();
    });
    $(".listImg2").click(function(){
        $(".popping2").show();
    });
    $(".listImg3").click(function(){
        $(".popping3").show();
    });
    $(".listImg4").click(function(){
        $(".popping4").show();
    });
    $(".popClose,.popping").click(function(){
        $(".popping").hide();
    });
